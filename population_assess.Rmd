...
author: "Farshad Ebrahimi, Jan/11/2023"
---
...
```{r section 3, looking at the unmonitored SMPs to see the break-down}
...
```{r section 4, adding the monitored and unmoniored}
...
```{r section 5, establish range for design metrics}
